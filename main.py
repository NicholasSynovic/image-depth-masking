...
def get_argparse():
    ...
    parser.add_argument(
        "-i",
        "--image_folder",
        help="image folder name. NOTE: must be in root directory",
        type=str,
        required=False,
    )
    parser.add_argument(
        "-m",
        "--model",
        help="optional, select model(0,1,2) to run on image folder. use: 0: DPT_Large, 1: DPT_Hybrid, 2: MiDaS_small, default -> 2: MiDaS_small",
        default=2,
        type=int,
        required=False,
    )
    parser.add_argument(
        "-df",
        "--depth_folder",
        help="Depth map folder name. Depth map folder generated by running with image folder first",
        type=str,
        required=False,
    )
    parser.add_argument(
        "-t",
        "--threshold",
        help="optional, threshold value for generating image mask",
        default=0.7,
        type=float,
        required=False,
    )
